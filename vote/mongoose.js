...
var url = "mongodb://localhost:27017/test"; // 本地数据库地址
...
var userSchema = Schema(test1)
var Test1 = mongoose.model('Test1', userSchema); //将schema编译为model构造函数

var newTest1 = new Test1({name: "lqy"})// Mongoose 会自动找到名称是 model 名字复数形式的 collection
newTest1.save();

module.exports = {mongoose,User,Test1}